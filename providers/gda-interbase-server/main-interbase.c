...
static GdaServerImplFunctions server_impl_functions = {
	...
	gda_interbase_connection_modify_schema,
	...
	gda_interbase_connection_sql2xml,
	gda_interbase_connection_xml2sql,
...
main (gint argc, gchar * argv[])
{
	...
	server_impl =
		gda_server_new
		("OAFIID:GNOME_GDA_Provider_InterBase_ConnectionFactory",
	...
	if (server_impl) {
		...
		gda_log_error (_
			       ("Could not register INTERBASE provider implementation"));
	return 0;
}
