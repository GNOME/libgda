...
gint
gda_mysql_connection_start_logging (Gda_ServerConnection *cnc, const gchar *filename)
{
	return -1;
}
...
gda_mysql_connection_get_gda_type (Gda_ServerConnection *cnc, gulong sql_type)
{
	...
	switch (sql_type) {
		case FIELD_TYPE_DECIMAL: return GDA_TypeDecimal;
		case FIELD_TYPE_TINY: return GDA_TypeTinyint;
		case FIELD_TYPE_SHORT: return GDA_TypeSmallint;
		case FIELD_TYPE_LONG: return GDA_TypeBigint;
		case FIELD_TYPE_FLOAT: return GDA_TypeSingle;
		case FIELD_TYPE_DOUBLE: return GDA_TypeDouble;
		case FIELD_TYPE_NULL: return GDA_TypeNull;
		case FIELD_TYPE_NEWDATE:
		case FIELD_TYPE_TIMESTAMP: return GDA_TypeDbTimestamp;
		case FIELD_TYPE_LONGLONG: return GDA_TypeUBigint;
		case FIELD_TYPE_INT24: return GDA_TypeBigint;
		case FIELD_TYPE_DATE: return GDA_TypeDbDate;
		case FIELD_TYPE_TIME: return GDA_TypeDbTime;
		case FIELD_TYPE_DATETIME: return GDA_TypeDbTimestamp;
		case FIELD_TYPE_YEAR: return GDA_TypeInteger;
		case FIELD_TYPE_ENUM: return GDA_TypeVarbin;
		case FIELD_TYPE_SET: return GDA_TypeVarbin;
		case FIELD_TYPE_TINY_BLOB:
		case FIELD_TYPE_MEDIUM_BLOB: return GDA_TypeVarbin;
		case FIELD_TYPE_LONG_BLOB:
		case FIELD_TYPE_BLOB: return GDA_TypeLongvarbin;
		case FIELD_TYPE_VAR_STRING:
		case FIELD_TYPE_STRING: return GDA_TypeVarchar;
	}
...
gchar *
gda_mysql_connection_sql2xml (Gda_ServerConnection *cnc, const gchar *sql)
{
	return NULL;
}

gchar *
gda_mysql_connection_xml2sql (Gda_ServerConnection *cnc, const gchar *xml)
{
	return NULL;
}
