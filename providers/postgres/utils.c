...
const gchar *
gda_data_type_to_string (GdaType type)
{
	gchar *result;
	...
	case GDA_TYPE_DATE :
		...
		break;
	case GDA_TYPE_DOUBLE :
		result = _("double precision");
		break;
	case GDA_TYPE_GEOMETRIC_POINT :
		result = _("geometric point");
		break;
	case GDA_TYPE_INTEGER :
		result = _("integer");
		break;
	case GDA_TYPE_LIST :
		result = _("list of values");
		break;
	case GDA_TYPE_NUMERIC :
		result = _("numeric");
		break;
	case GDA_TYPE_SINGLE :
		result = _("single precision");
		break;
	case GDA_TYPE_SMALLINT :
		result = _("small integer");
		break;
	case GDA_TYPE_STRING :
		result = _("string");
		break;
	...
	case GDA_TYPE_TIMESTAMP :
		result = _("timestamp");
		break;
	case GDA_TYPE_TINYINT :
		result = _("tiny integer");
		break;
	default:
