...
glong
gda_mail_connection_modify_schema (Gda_ServerConnection *cnc,
                                   GDA_Connection_QType t,
                                   GDA_Connection_Constraint *constraints,
                                   gint length)
{
...
gchar *
gda_mail_connection_sql2xml (Gda_ServerConnection *cnc, const gchar *sql)
{
  return NULL;
}

gchar *
gda_mail_connection_xml2sql (Gda_ServerConnection *cnc, const gchar *xml)
{
  return NULL;
}
