...
#define GDA_XML_LIST_ITEM(obj)            (G_TYPE_CHECK_INSTANCE_CAST (obj, GDA_TYPE_XML_LIST_ITEM, GdaXmlListItem))
#define GDA_XML_LIST_ITEM_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST (klass, GDA_TYPE_XML_LIST_ITEM, GdaXmlListItemClass))
#define GDA_IS_XML_LIST_ITEM(obj)         (G_TYPE_CHECK_INSTANCE_TYPE (obj, GDA_TYPE_XML_LIST_ITEM))
#define GDA_IS_XML_LIST_ITEM_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), GDA_TYPE_XML_LIST_ITEM))
...
GType       gda_xml_list_item_get_type (void);
