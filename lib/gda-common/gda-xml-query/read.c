...
typedef XmlQueryItem *(Constructor) (gchar * tag, gchar * sqlfmt,
				     gchar * sqlop);
...
static void init_node_table (void);

static XmlQueryItem *proc_node (xmlNode * node, XmlQueryItem * parent);

static void proc_attr (xmlAttr * attr, XmlQueryItem * item);
...
init_node_table (void)
{
	...
	g_hash_table_insert (nodeTable, "unionall",
			     xml_query_bin_new_unionall);
	g_hash_table_insert (nodeTable, "intersect",
			     xml_query_bin_new_intersect);
	...
	g_hash_table_insert (nodeTable, "arglist",
			     xml_query_list_new_arglist);
	g_hash_table_insert (nodeTable, "setlist",
			     xml_query_list_new_setlist);
	g_hash_table_insert (nodeTable, "sourcelist",
			     xml_query_list_new_sourcelist);
	g_hash_table_insert (nodeTable, "targetlist",
			     xml_query_list_new_targetlist);
	g_hash_table_insert (nodeTable, "valuelist",
			     xml_query_list_new_valuelist);
	g_hash_table_insert (nodeTable, "joinlist",
			     xml_query_list_new_joinlist);
