...
#ifdef HAVE_GOBJECT
static void
gda_connection_pool_class_init (GdaConnectionPoolClass * klass, gpointer data)
{
...
{
#ifdef HAVE_GOBJECT
	return GDA_CONNECTION_POOL (g_object_new
				    (GDA_TYPE_CONNECTION_POOL, NULL));
#else
