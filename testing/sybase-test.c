...
{
	return execute_non_query (cnc, "if exists (select name from sysobjects where (type = 'U') and (name = 'gda_sybase_test')) drop table gda_sybase_test");
}
