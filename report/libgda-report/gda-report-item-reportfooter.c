...
static void gda_report_item_reportfooter_finalize   (GObject *object);

static GdaReportItemClass *parent_class = NULL;

/*
 * GdaReportItemReportFooter class implementation
 */
static void
gda_report_item_reportfooter_class_init (GdaReportItemReportFooterClass *klass)
{
	GObjectClass *object_class = G_OBJECT_CLASS (klass);

	parent_class = g_type_class_peek_parent (klass);
	object_class->finalize = gda_report_item_reportfooter_finalize;
}


static void
gda_report_item_reportfooter_init (GdaReportItemReportFooter *item, 
		      	           GdaReportItemReportFooterClass *klass)
{
...
static void
gda_report_item_reportfooter_finalize (GObject *object)
{
	g_return_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER (object));
...
GType
gda_report_item_reportfooter_get_type (void)
{
	static GType type = 0;

	if (!type) {
		static const GTypeInfo info = {
			sizeof (GdaReportItemReportFooterClass),
			(GBaseInitFunc) NULL,
			(GBaseFinalizeFunc) NULL,
			(GClassInitFunc) gda_report_item_reportfooter_class_init,
			NULL,
			NULL,
			sizeof (GdaReportItemReportFooter),
			0,
			(GInstanceInitFunc) gda_report_item_reportfooter_init
		};
		type = g_type_register_static (GDA_REPORT_TYPE_ITEM, "GdaReportItemReportFooter", &info, 0);
	}
	return type;
}
...
/*
 * gda_report_item_reportfooter_new
 */
GdaReportItem *
gda_report_item_reportfooter_new (GdaReportValid *valid)
{
	GdaReportItemReportFooter *item;
	
	g_return_val_if_fail (GDA_IS_REPORT_VALID(valid), NULL);
	
	item = g_object_new (GDA_REPORT_TYPE_ITEM_REPORTFOOTER, NULL);
	GDA_REPORT_ITEM(item)->priv->valid = valid;
	GDA_REPORT_ITEM(item)->priv->node = xmlNewNode(NULL, ITEM_REPORTFOOTER_NAME);	
...
/*
 * gda_report_item_reportfooter_new_from_dom
 */
GdaReportItem *
...
/*
 * gda_report_item_reportfooter_to_dom
 */
xmlNodePtr 
gda_report_item_reportfooter_to_dom (GdaReportItem *item)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), NULL);
...
/*
 * gda_report_item_reportfooter_remove
 */
gboolean 
gda_report_item_reportfooter_remove (GdaReportItem *item)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
	return gda_report_item_remove (item);
}


/*
 * gda_report_item_reportfooter_add_element
 */
gboolean
gda_report_item_reportfooter_add_element (GdaReportItem *reportfooter,
					  GdaReportItem *element)
{
	gchar *id;
	
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(reportfooter), FALSE);
	...
	g_return_val_if_fail (gda_report_item_belongs_to_report_document(reportfooter), FALSE);

	id = gda_report_item_get_attribute (element, "id");
	if (gda_report_item_get_child_by_id (
		gda_report_item_get_report (reportfooter), id) != NULL)
	{
		gda_log_error (_("An element with ID %s already exists in the report"), id);
		return FALSE;
	}	
	return gda_report_item_add_child (reportfooter, element);
}



/*
 * gda_report_item_reportfooter_get_label_by_id
 */
GdaReportItem *
gda_report_item_reportfooter_get_label_by_id (GdaReportItem *reportfooter,
				              const gchar *id)
{
	GdaReportItem *label;
	
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER (reportfooter), NULL);
	g_return_val_if_fail (id != NULL, NULL);
	
	label = gda_report_item_get_child_by_id (reportfooter, id);
	if (label != NULL)
	{
...
/*
 * gda_report_item_reportfooter_get_repfield_by_id
 */
GdaReportItem *
gda_report_item_reportfooter_get_repfield_by_id (GdaReportItem *reportfooter,
				                 const gchar *id)
{
	...
	repfield = gda_report_item_get_child_by_id (reportfooter, id);
	if (repfield != NULL)
	{
...
/*
 * gda_report_item_reportfooter_set_active
 */
gboolean 
gda_report_item_reportfooter_set_active (GdaReportItem *item,
					 const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_active
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_visible
 */
gboolean 
gda_report_item_reportfooter_set_visible (GdaReportItem *item,
					  const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_visible
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_height
 */
gboolean 
gda_report_item_reportfooter_set_height (GdaReportItem *item,
...
/*
 * gda_report_item_reportfooter_set_newpage
 */
gboolean 
gda_report_item_reportfooter_set_newpage (GdaReportItem *item,
					  const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_newpage
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_bgcolor
 */
gboolean 
gda_report_item_reportfooter_set_bgcolor (GdaReportItem *item,
 ...
 */
gboolean 
gda_report_item_reportfooter_set_fgcolor (GdaReportItem *item,
				          GdaReportColor *color)
{
	gchar *value;
...
/*
 * gda_report_item_reportfooter_get_fgcolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_reportfooter_set_bordercolor
 */
gboolean 
gda_report_item_reportfooter_set_bordercolor (GdaReportItem *item,
				              GdaReportColor *color)
{
	gchar *value;
...
/*
 * gda_report_item_reportfooter_get_bordercolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_reportfooter_set_borderwidth
 */
gboolean 
gda_report_item_reportfooter_set_borderwidth (GdaReportItem *item,
					      GdaReportNumber *number)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_set_borderstyle
 */
gboolean 
gda_report_item_reportfooter_set_borderstyle (GdaReportItem *item,
					      const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_borderstyle
 */
gchar * 
 ...
 */
gboolean 
gda_report_item_reportfooter_set_fontfamily (GdaReportItem *item,
					     const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_fontfamily
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_fontsize
 */
gboolean 
gda_report_item_reportfooter_set_fontsize (GdaReportItem *item,
					   GdaReportNumber *number)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_fontsize
 */
GdaReportNumber *
 ...
 */
gboolean 
gda_report_item_reportfooter_set_fontweight (GdaReportItem *item,
					     const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_fontweight
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_fontitalic
 */
gboolean 
gda_report_item_reportfooter_set_fontitalic (GdaReportItem *item,
					     const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_fontitalic
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_halignment
 */
gboolean 
gda_report_item_reportfooter_set_halignment (GdaReportItem *item,
					     const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_set_valignment
 */
gboolean 
gda_report_item_reportfooter_set_valignment (GdaReportItem *item,
					     const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
 ...
 */
gboolean 
gda_report_item_reportfooter_set_wordwrap (GdaReportItem *item,
					     const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_wordwrap
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_negvaluecolor
 */
gboolean 
gda_report_item_reportfooter_set_negvaluecolor (GdaReportItem *item,
				                 GdaReportColor *color)
{
	gchar *value;
...
/*
 * gda_report_item_reportfooter_get_negvaluecolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_reportfooter_set_dateformat
 */
gboolean 
gda_report_item_reportfooter_set_dateformat (GdaReportItem *item,
					     const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_dateformat
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_precision
 */
gboolean 
gda_report_item_reportfooter_set_precision (GdaReportItem *item,
					    GdaReportNumber *number)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_set_currency
 */
gboolean 
gda_report_item_reportfooter_set_currency (GdaReportItem *item,
					   const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_set_commaseparator
 */
gboolean 
gda_report_item_reportfooter_set_commaseparator (GdaReportItem *item,
					         const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_commaseparator
 */
gchar * 
...
/*
 * gda_report_item_reportfooter_set_linewidth
 */
gboolean 
gda_report_item_reportfooter_set_linewidth (GdaReportItem *item,
					    GdaReportNumber *number)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
...
/*
 * gda_report_item_reportfooter_get_linewidth
 */
GdaReportNumber *
...
/*
 * gda_report_item_reportfooter_set_linecolor
 */
gboolean 
gda_report_item_reportfooter_set_linecolor (GdaReportItem *item,
				            GdaReportColor *color)
{
	gchar *value;
...
/*
 * gda_report_item_reportfooter_get_linecolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_reportfooter_set_linestyle
 */
gboolean 
gda_report_item_reportfooter_set_linestyle (GdaReportItem *item,
					    const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_REPORTFOOTER(item), FALSE);
