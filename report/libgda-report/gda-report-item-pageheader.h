...
GType gda_report_item_pageheader_get_type (void) G_GNUC_CONST;
...
gboolean gda_report_item_pageheader_remove (GdaReportItem *item);

gboolean gda_report_item_pageheader_add_element (GdaReportItem *pageheader,
