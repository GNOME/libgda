...
static void gda_report_item_pageheader_init       (GdaReportItemPageHeader *valid,
					             GdaReportItemPageHeaderClass *klass);
static void gda_report_item_pageheader_finalize   (GObject *object);

static GdaReportItemClass *parent_class = NULL;

/*
 * GdaReportItemPageHeader class implementation
 */
static void
gda_report_item_pageheader_class_init (GdaReportItemPageHeaderClass *klass)
{
	GObjectClass *object_class = G_OBJECT_CLASS (klass);

	parent_class = g_type_class_peek_parent (klass);
	object_class->finalize = gda_report_item_pageheader_finalize;
}


static void
gda_report_item_pageheader_init (GdaReportItemPageHeader *item, 
		      	         GdaReportItemPageHeaderClass *klass)
{
...
static void
gda_report_item_pageheader_finalize (GObject *object)
{
	g_return_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER (object));
...
GType
gda_report_item_pageheader_get_type (void)
{
	static GType type = 0;

	if (!type) {
		static const GTypeInfo info = {
			sizeof (GdaReportItemPageHeaderClass),
			(GBaseInitFunc) NULL,
			(GBaseFinalizeFunc) NULL,
			(GClassInitFunc) gda_report_item_pageheader_class_init,
			NULL,
			NULL,
			sizeof (GdaReportItemPageHeader),
			0,
			(GInstanceInitFunc) gda_report_item_pageheader_init
		};
		type = g_type_register_static (GDA_REPORT_TYPE_ITEM, "GdaReportItemPageHeader", &info, 0);
	}
	return type;
}
...
/*
 * gda_report_item_pageheader_new
 */
GdaReportItem *
gda_report_item_pageheader_new (GdaReportValid *valid)
{
	GdaReportItemPageHeader *item;
	
	g_return_val_if_fail (GDA_IS_REPORT_VALID(valid), NULL);
	
	item = g_object_new (GDA_REPORT_TYPE_ITEM_PAGEHEADER, NULL);
	GDA_REPORT_ITEM(item)->priv->valid = valid;
	GDA_REPORT_ITEM(item)->priv->node = xmlNewNode(NULL, ITEM_PAGEHEADER_NAME);	
...
/*
 * gda_report_item_pageheader_new_from_dom
 */
GdaReportItem *
...
/*
 * gda_report_item_pageheader_to_dom
 */
xmlNodePtr 
...
/*
 * gda_report_item_pageheader_get_repfield_by_id
 */
GdaReportItem *
gda_report_item_pageheader_get_repfield_by_id (GdaReportItem *pageheader,
				               const gchar *id)
{
	...
	repfield = gda_report_item_get_child_by_id (pageheader, id);
	if (repfield != NULL)
	{
 ...
 */
gboolean 
gda_report_item_pageheader_set_active (GdaReportItem *item,
					 const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_active
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_visible
 */
gboolean 
gda_report_item_pageheader_set_visible (GdaReportItem *item,
					  const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_visible
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_height
 */
gboolean 
gda_report_item_pageheader_set_height (GdaReportItem *item,
...
/*
 * gda_report_item_pageheader_get_height
 */
GdaReportNumber *
...
/*
 * gda_report_item_pageheader_set_positionfreq
 */
gboolean 
gda_report_item_pageheader_set_positionfreq (GdaReportItem *item,
					     const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_positionfreq
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_pagefreq
 */
gboolean 
gda_report_item_pageheader_set_pagefreq (GdaReportItem *item,
					 const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_pagefreq
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_bgcolor
 */
gboolean 
gda_report_item_pageheader_set_bgcolor (GdaReportItem *item,
...
/*
 * gda_report_item_pageheader_get_bgcolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_pageheader_set_fgcolor
 */
gboolean 
gda_report_item_pageheader_set_fgcolor (GdaReportItem *item,
				          GdaReportColor *color)
{
	gchar *value;
...
/*
 * gda_report_item_pageheader_get_fgcolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_pageheader_set_bordercolor
 */
gboolean 
gda_report_item_pageheader_set_bordercolor (GdaReportItem *item,
					    GdaReportColor *color)
{
	gchar *value;
...
/*
 * gda_report_item_pageheader_get_bordercolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_pageheader_set_borderwidth
 */
gboolean 
gda_report_item_pageheader_set_borderwidth (GdaReportItem *item,
					    GdaReportNumber *number)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_borderwidth
 */
GdaReportNumber *
...
/*
 * gda_report_item_pageheader_set_borderstyle
 */
gboolean 
gda_report_item_pageheader_set_borderstyle (GdaReportItem *item,
					    const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_borderstyle
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_fontfamily
 */
gboolean 
gda_report_item_pageheader_set_fontfamily (GdaReportItem *item,
					   const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_fontfamily
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_fontsize
 */
gboolean 
gda_report_item_pageheader_set_fontsize (GdaReportItem *item,
					 GdaReportNumber *number)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_fontsize
 */
GdaReportNumber *
...
/*
 * gda_report_item_pageheader_set_fontweight
 */
gboolean 
gda_report_item_pageheader_set_fontweight (GdaReportItem *item,
					   const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_fontweight
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_fontitalic
 */
gboolean 
gda_report_item_pageheader_set_fontitalic (GdaReportItem *item,
					   const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_fontitalic
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_halignment
 */
gboolean 
gda_report_item_pageheader_set_halignment (GdaReportItem *item,
					   const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_halignment
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_valignment
 */
gboolean 
gda_report_item_pageheader_set_valignment (GdaReportItem *item,
					   const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_valignment
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_wordwrap
 */
gboolean 
gda_report_item_pageheader_set_wordwrap (GdaReportItem *item,
					 const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_wordwrap
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_negvaluecolor
 */
gboolean 
gda_report_item_pageheader_set_negvaluecolor (GdaReportItem *item,
				              GdaReportColor *color)
{
	gchar *value;
...
/*
 * gda_report_item_pageheader_get_negvaluecolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_pageheader_set_dateformat
 */
gboolean 
gda_report_item_pageheader_set_dateformat (GdaReportItem *item,
					   const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_dateformat
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_precision
 */
gboolean 
gda_report_item_pageheader_set_precision (GdaReportItem *item,
					  GdaReportNumber *number)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_precision
 */
GdaReportNumber *
 ...
 */
gboolean 
gda_report_item_pageheader_set_currency (GdaReportItem *item,
					 const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_currency
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_commaseparator
 */
gboolean 
gda_report_item_pageheader_set_commaseparator (GdaReportItem *item,
					       const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_commaseparator
 */
gchar * 
...
/*
 * gda_report_item_pageheader_set_linewidth
 */
gboolean 
gda_report_item_pageheader_set_linewidth (GdaReportItem *item,
					  GdaReportNumber *number)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_linewidth
 */
GdaReportNumber *
...
/*
 * gda_report_item_pageheader_set_linecolor
 */
gboolean 
gda_report_item_pageheader_set_linecolor (GdaReportItem *item,
				          GdaReportColor *color)
{
	gchar *value;
...
/*
 * gda_report_item_pageheader_get_linecolor
 */
GdaReportColor * 
...
/*
 * gda_report_item_pageheader_set_linestyle
 */
gboolean 
gda_report_item_pageheader_set_linestyle (GdaReportItem *item,
					  const gchar *value)
{
	g_return_val_if_fail (GDA_REPORT_IS_ITEM_PAGEHEADER(item), FALSE);
...
/*
 * gda_report_item_pageheader_get_linestyle
 */
gchar * 
