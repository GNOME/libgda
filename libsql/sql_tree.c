...
sql_select_statement_build(int distinct, GList * fields, GList * from, sql_where * where, GList * order, GList * group)
   {
...
sql_field_item *
sql_field_item_build_equation(sql_field_item * left, sql_field_item * right, sql_field_operator op)
   {
   sql_field_item *item;
...
sql_table *
sql_table_build_join(sql_table * left, sql_table * right, sql_condition * cond)
   {
   sql_table *retval;
...
sql_where *
sql_where_build_pair(sql_where * left, sql_where * right, sql_logic_operator op)
   {
   sql_where *retval;
...
sql_condition *
sql_build_condition(sql_field * left, sql_field * right, sql_condition_operator op)
   {
...
sql_condition *
sql_build_condition_between(sql_field * field, sql_field * lower, sql_field * upper)
   {
   sql_condition *retval;
