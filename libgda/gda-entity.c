...
gda_entity_get_parameters (GdaEntity *iface)
{
	...
	if (GDA_ENTITY_GET_IFACE (iface)->get_parameters)
		return (GDA_ENTITY_GET_IFACE (iface)->get_parameters) (iface);	
 ...
 * This function is similar to gda_entity_get_parameters() except that it also creates a
...
gda_entity_get_param_list (GdaEntity *iface)
{
	...
	params = gda_entity_get_parameters (iface);
