...
GdaDataHandler     *gda_provider_get_data_handler      (GdaProvider *provider, GdaConnection *cnc, /* may be NULL */
                                                        GType g_type, const gchar *dbms_type);
const gchar        *gda_provider_get_def_dbms_type     (GdaProvider *provider, GdaConnection *cnc, GType g_type); /* may be NULL */
...
gchar        *gda_provider_escape_string               (GdaProvider *provider, GdaConnection *cnc, const gchar *str); /* may be NULL */
gchar        *gda_provider_unescape_string             (GdaProvider *provider, GdaConnection *cnc, const gchar *str); /* may be NULL */
