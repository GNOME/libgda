 ...
 * gda_set_get_holders:
 *
 * Returns: (element-type Gda.Holder): a list of #GdaHolder objects in the set
 */
GSList*
 ...
 * gda_set_get_nodes:
 *
 * Returns: (element-type Gda.SetNode): a list of #GdaSetNode objects in the set
 */
GSList*
 ...
 * gda_set_get_sources:
 *
 * Returns: (element-type Gda.SetSource): a list of #GdaSetSource objects in the set
 */
GSList*
 ...
 * gda_set_get_groups:
 *
 * Returns: (element-type Gda.SetGroup): a list of #GdaSetGroup objects in the set
 */
GSList*
