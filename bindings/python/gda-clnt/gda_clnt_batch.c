...
_wrap_gda_batch_load_file (PyObject * dummy, PyObject * args)
{
	...
	return PyInt_FromLong (gda_batch_load_file
			       (GDA_BATCH (gtk_get (job)), filename, clean));
}
...
_wrap_gda_batch_is_running (PyObject * dymmy, PyObject * args)
{
	...
	return PyInt_FromLong (gda_batch_is_running
			       (GDA_BATCH (gtk_get (job))));
}
...
_wrap_gda_batch_get_connection (PyObject * dymmy, PyObject * args)
{
	...
	return PyGtk_New ((GtkObject
			   *) (gda_batch_get_connection (GDA_BATCH
							 (gtk_get (job)))));
...
_wrap_gda_batch_set_connection (PyObject * dymmy, PyObject * args)
{
	...
	if (!PyArg_ParseTuple (args, "O!O!:gda_batch_set_connection",
			       &GtkObject_Type, &job, &GtkObject_Type, &cnc))
		return NULL;

	gda_batch_set_connection (GDA_BATCH (gtk_get (job)),
...
_wrap_gda_batch_get_transaction_mode (PyObject * dymmy, PyObject * args)
{
	...
	return PyInt_FromLong (gda_batch_get_transaction_mode
			       (GDA_BATCH (gtk_get (job))));
}
