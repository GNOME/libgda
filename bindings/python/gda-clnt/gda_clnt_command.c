...
_wrap_gda_command_get_connection (PyObject *dymmy, PyObject *args) {
    ...
    return PyGtk_New ((GtkObject *)(gda_command_get_connection (GDA_COMMAND(gtk_get(cmd)))));
...
_wrap_gda_command_set_connection (PyObject *dymmy, PyObject *args) {
    ...
    return PyInt_FromLong (gda_command_set_connection (GDA_COMMAND(gtk_get(cmd)), 
...
_wrap_gda_command_get_text (PyObject *dymmy, PyObject *args) {
    ...
    return PyString_FromString (gda_command_get_text (GDA_COMMAND(gtk_get(cmd))));
}
...
_wrap_gda_command_get_cmd_type (PyObject *dymmy, PyObject *args) {
    ...
    return PyInt_FromLong (gda_command_get_cmd_type (GDA_COMMAND(gtk_get(cmd))));
}
...
_wrap_gda_command_execute (PyObject *dymmy, PyObject *args) {
    ...
    return PyGtk_New ((GtkObject *)(gda_command_execute (GDA_COMMAND(gtk_get(cmd)), 
							 &reccount, flags)));
}
...
_wrap_gda_command_get_timeout (PyObject *dymmy, PyObject *args) {
    ...
    return PyLong_FromLong (gda_command_get_timeout (GDA_COMMAND(gtk_get(cmd))));
}
