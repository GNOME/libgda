...
namespace Gdaui {
	...
	[CCode (cheader_filename = "Gdaui-5.0.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gdaui_set_group_get_type ()")]
	[Compact]
	...
	[CCode (cheader_filename = "Gdaui-5.0.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gdaui_set_source_get_type ()")]
	[Compact]
	...
	[CCode (cheader_filename = "Gdaui-5.0.h", cprefix = "GDAUI_DATA_PROXY_WRITE_ON_", has_type_id = false)]
