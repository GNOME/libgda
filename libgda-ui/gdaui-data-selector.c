 ...
 * and #GdauiGrid).
 *
 * Returns: (transfer full) (element-type int): an array of #gint values, one for each selected row. Use g_array_free() when finished (passing %TRUE as the last argument)
 *
 * Since: 4.2
 */
GArray *
