...
void               customization_data_init           (GObject *object, GtkToolbar *toolbar, GtkHeaderBar *header);
gboolean           customization_data_exists         (GObject *object);
void               customization_data_add_part       (GObject *object, GObject *part);
void               customization_data_add_actions    (GObject *object, GActionEntry *entries, guint n_entries);
